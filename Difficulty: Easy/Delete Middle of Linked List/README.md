<h2><a href="https://www.geeksforgeeks.org/problems/delete-middle-of-linked-list/1?page=3&category=Linked%20List&sortBy=difficulty">Delete Middle of Linked List</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 14pt;">Given a singly linked list, delete the <strong>middle&nbsp;</strong>of the linked list.</span></p>
